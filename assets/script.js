$(document).ready(function () {
    ...
    function displayWeather(city) {
        //setting weatherURL to variable and then concating city the user entered.
        ...
        $.ajax({
            ...
            //dynamically creating h3 tag and then appending the city name from the api
            ...
            cityHeading.append(date, img); //appends and displays city's name with date and weather icon
